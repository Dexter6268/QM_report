...
def get_evaluation_llm(eval_model=None):
    ...
    model_to_use = eval_model or os.environ.get("EVAL_MODEL", "DeepSeek-R1-671B")
...
def eval_model(request):
    ...
    return request.config.getoption("--eval-model") or os.environ.get("EVAL_MODEL", "DeepSeek-R1-671B")
    ...
    if research_agent == "multi_agent":
        return {
            "supervisor_model": (
                ...
                os.environ.get("SUPERVISOR_MODEL", "DeepSeek-R1-671B")
            ),
            "researcher_model": (
                request.config.getoption("--researcher-model") or 
                os.environ.get("RESEARCHER_MODEL", "DeepSeek-R1-671B")
            ),
        }
    else:  # graph agent
        return {
            ...
            "planner_model": (
                ...
                os.environ.get("PLANNER_MODEL", "DeepSeek-R1-671B")
            ),
            "writer_provider": (
            ...
            "writer_model": (
                ...
                os.environ.get("WRITER_MODEL", "DeepSeek-R1-671B")
            ),
...
def test_response_criteria_evaluation(research_agent, search_api, models, eval_model):
    ...
    if research_agent == "multi_agent":
        ...
        thread = {"configurable": {
            ...
            "planner_model": models.get("planner_model", "DeepSeek-R1-671B"),
            "writer_provider": models.get("writer_provider", "anthropic"),
            "writer_model": models.get("writer_model", "DeepSeek-R1-671B"),
